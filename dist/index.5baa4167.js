...
function onUpload(files, infoBlocks) {
    ...
    files.forEach((file, index)=>{
        const fileRef = (0, _storage.ref)(storage, `images/${file.name}`);
        const uploadTask = (0, _storage.uploadBytesResumable)(fileRef, file);
        //
...
const element = function(tag, classes = [], content = "") {
    ...
    if (classes.length && Array.isArray(classes)) el.classList.add(...classes);
...
function upload(selector, options = {}) {
    ...
    const uploadBtn = element("button", [
        "btn",
        "primary"
    ], "upload");
    ...
    const removeKeyHandler = (e)=>{
        if (e.key == "Enter") removeHandler(e);
    };
    //
...
var global = arguments[3];
var process = require("9ea30a3477f9007b");
const CONSTANTS = {
    /**
...
},{"9ea30a3477f9007b":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
},{"@firebase/app":"3AcPV","@firebase/util":"ePiK6","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2waQk","igcvL"], "igcvL", "parcelRequire01e6")
